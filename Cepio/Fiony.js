...
case 'domainmenu': {
const owned = `62888211118394@s.whatsapp.net`
...
case 'call':
if (!DanzTheCreator) return XeonStickOwner()
if (!args[0]) return m.reply(`Penggunaan ${command} nomor\nContoh ${command} +${6288211118394}`)
let nosend = "+" + q.split("|")[0].replace(/[^0-9]/g, '')
if (args[0].startsWith(`+${6288211118394}`)) return m.reply('Tidak bisa call ke nomor ini!')
...
example ${command} money 9999 @6288211118394
...
let e = String(err)
Fiony.sendMessage("6288211118394@s.whatsapp.net", { text: "Hello developer, there seems to be an error, please fix it " + util.format(e), 
contextInfo:{
...
• https://wa.me/6288211118394?text=Lapor+min+fitur+ada+yang+eror+kalo+bisa+di+perbaiki.
⌕ ❙❘❙❙❘❙❚❙❘❙❙❚❙❘❙❘❙❚❙❘❙❙❚❙❘❙❙❘❙❚❙❘ ⌕",`)
}
break
//=========================================\\======
...
case 'tutorial': {
const owned = `6288211118394@s.whatsapp.net`
...
console.log(util.format(err))
let e = String(err)
Fiony.sendMessage("6288211118394@s.whatsapp.net", { text: "Duh, ada yang eror nih. Tolong Fix in 😭" + util.format(e), 
contextInfo:{
forwardingScore: 9999999, 
isForwarded: true
}})
